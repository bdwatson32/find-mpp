...
Then mention the skill when you want it applied (e.g. “use the find-mpp skill”), or rely on your agent rules if you map triggers to this skill.

## Before you publish

1. Open `find-mpp/SKILL.md`.
